        ...
        gameLoop: while (true) {
            ...
            for (boolean playersTurn = true; win == 0; playersTurn ^= true) {
                ...
                if (playersTurn) /***** Player's turn ******/
                {
                    ...
                    // The choices were incremented to make them seem more natural (i.e not starting
                    // with 0)
                            ...
                            switch (topCard.value) {
                                ...
                                case 14: // Wild cards
                                    do // Repeats every time the user doesn't input a valid color
                                    {
                                        ...
                                        input = new Scanner(System.in);
                                    } while (!input.hasNext("R..|r..|G....|g....|B...|b...|Y.....|y.....")); // Something
                                                                                                             // I
                                                                                                             // learned
                                                                                                             // recently
                ...
                } else /************ computer's turn **************/
                {
                    ...
                    for (choiceIndex = 0; choiceIndex < compdeck.size(); choiceIndex++) {
                        if (((Unocard) compdeck.get(choiceIndex)).canPlace(topCard, currentColor)) // Searching for
                                                                                                   // playable cards
                            break;
                    }
